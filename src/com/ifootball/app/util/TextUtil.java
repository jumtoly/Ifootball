 ...
 * 	@see TextUtil.applyFormatStyleSpannable(String fromatString,LinkedList<String> args,LinkedList<TextUtil.TextStyleWrapper> styleWrapperList)
 * 	@see TextUtil.applyFormatStyleAllParamSections(String fromatString,LinkedList<String> args,LinkedList<TextUtil.TextStyleWrapper> styleWrapperList)
 * 
...
public class TextUtil {
	 ...
	 */
	public static String applyFormatStyleByHTMLParser(String fromatString,LinkedList<String> args,LinkedList<TextUtil.TextStyleWrapper> styleWrapperList) throws Exception{
	 ...
	 * 		The count of args is not equal with params count in format string.
	 */
	public static String applyFormatStyleAllParamSectionsByHTMLParser(String fromatString,LinkedList<String> args,LinkedList<TextUtil.TextStyleWrapper> styleWrapperList) throws Exception{
	 ...
	 * 		The count of args is not equal with params count in format string.
	 */
	public static SpannableString applyFormatStyleSpannable(String fromatString,LinkedList<String> args,LinkedList<TextUtil.TextStyleWrapper> styleWrapperList) throws Exception{
	 ...
	 * 		The count of args is not equal with params count in format string.
	 */
	public static SpannableString applyFormatStyleAllParamSections(String fromatString,LinkedList<String> args,LinkedList<TextUtil.TextStyleWrapper> styleWrapperList) throws Exception{
	...
	private static LinkedHashMap<String, TextStyleWrapper> getAllParamsTextStyleMap(String fromatString,LinkedList<String> args,LinkedList<TextUtil.TextStyleWrapper> styleWrapperList) throws Exception{
        ...
        LinkedHashMap<String, TextUtil.TextStyleWrapper> map = new LinkedHashMap<String, TextUtil.TextStyleWrapper>();
        
        if (styleWrapperList == null || styleWrapperList.size() == 0) {
        	
        	LinkedList<TextUtil.TextStyleWrapper> defaultTextStyleWrappers = new LinkedList<TextUtil.TextStyleWrapper>();
        	for (int i = 0; i < 1 + args.size(); i++) {
        		defaultTextStyleWrappers.add(new TextUtil.TextStyleWrapper());
			}
			...
			for (int i = 0; i < 1 + args.size() - styleCount; i++) {
				styleWrapperList.add(new TextUtil.TextStyleWrapper());
			}
		}
	...
	private static LinkedHashMap<String, TextStyleWrapper> getTextStyleMap(String fromatString,LinkedList<String> args,LinkedList<TextUtil.TextStyleWrapper> styleWrapperList) throws Exception{
        ...
        if (styleWrapperList == null || styleWrapperList.size() == 0) {
        	...
        	LinkedList<TextUtil.TextStyleWrapper> defaulTextStyleWrappers = new LinkedList<TextUtil.TextStyleWrapper>();
        	for (int i = 0; i < 2; i++) {
        		defaulTextStyleWrappers.add(new TextUtil.TextStyleWrapper());
			}
